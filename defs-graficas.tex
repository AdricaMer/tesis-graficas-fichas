...
una \indice{subgr\'afica} de $G$. Por otra parte, decimos que $G$ es una
...
\begin{figure}[htb!]
    ...
    \end{tikzpicture}
    \caption{Una gr\'afica,resaltando las ${\color{morado}\bf aristas}$ de un
    ${\color{coral}\bf v_3 v_5}$-camino con su ${\color{coral}\bf v_3
    v_5}$-trayectoria contenida, resaltando
    ${\color{morado}\textbf{v\'ertices}}$ de \'esta \'ultima.  Tambi\'en se
    resalta una ${\color{coral}\bf v_3 v_5}$-trayectoria sin cuerdas de color
...
gr\'aficas. \'Esto tambi\'en se puede observar en el ejemplo de
\cref{fig:ex-Bip}.
...
Una proposici\'on que nos servir\'a m\'as adelante es \cref{prop:hamilt}, a
continuaci\'on demostrada.
...
\indiceSub{$k$-coloraci\'on}{propia por aristas}\index{aristas!$k$-coloraci\'on
propia} es una coloraci\'on por aristas, donde se le asignan colores diferentes
...
color. Tambi\'en podemos determinar c\'omo se ven las gr\'aficas $2$-crom\'aticas.
...
\begin{proof}
    ...
    De esta manera tenemos que $G$ es $k+l$-coloreable, donde $k = \chi(G[S])$ y
    $l = '\chi(G-S)$. Por lo tanto, tenemos que $\chi(G) \leq
    \chi(G[S])+\chi(G-S)$.
\end{proof}
