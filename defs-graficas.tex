...
conjuntos. Sean $X,Y \subseteq V(G)$, definimos la trayectoria $P=(v_1,\dots,
v_r)$ como una $XY$-trayectoria si sucede que $V(P) \cap X= \{v_1\}$ y $V(P) \cap Y=
\{v_r\}$.
...
\index{gr\'afica!t @$t$-conexa} si $|V(G)|>t$ y $G-X$ es conexa para todo
