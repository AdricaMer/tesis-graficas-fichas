...
decir que $u$ y $v$ son \textbf{v\'ertices} \indiceSub{v\'ertices}{adyacentes} o
\indiceSub{v\'ertices}{vecinos} y lo denotamos $u \sim v$. Esta relaci\'on entre
v\'ertices la llamamos adyacencia. Al conjunto de vecinos de un v\'ertice $v$ se
le llama \indice{vecindad}, y se denota $N_G(v)$, mientras que al n\'umero de
aristas incidentes en $v$ se le llama \indice{grado} de $v$, $d(v)$. Un
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{scope}[xshift=0cm,scale=1]
                ...
                \draw ({(360/4) - 45}:2) node(1)[avertex, fill=morado, label=(360/4) -
                    45:{\large $k_{1}$}]{};
