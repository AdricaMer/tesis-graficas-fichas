...
gr\'afica es \indiceSub{gr\'afica}{bipartita completa} si es bipartita y dada la
...
subtrayectoria hamiltoniana. Definimos una \indice{subtrayectoria hamiltoniana}
...
\begin{figure}[ht!]
    \centering
        ...
        \begin{scope}[xshift=7cm,scale=1]
            \draw (-2.4,1.4) node (v1) [vertex,label=180:{\small $v_1$}] {};
            \draw (-1.2,1.8) node (v2) [vertex,label=135:{\small $v_2$}] {};
            \draw (0,2) node (v3) [vertex,label=90:{\small $v_3$}] {}; 
            \draw (1.2,1.8) node (v4) [bvertex,label=45:{\small $v_4$}] {}; 
            \draw (2.4,1.4) node (v5) [vertex,label=0:{\small $v_5$}] {}; 
