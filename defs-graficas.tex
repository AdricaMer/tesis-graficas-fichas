...
Una gr\'afica $G$ es una terna ordenada $(V(G), E(G), \psi_G)$ donde $V(G)$ y
$E(G)$ son conjuntos finitos. Los elementos de $V(G)$ son llamados v\'ertices y
los elementos de $E(G)$ son aristas. Adem\'as cumplen $V(G) \cap E(G) =
\varnothing$. La funci\'on $\psi_G: E(G) \rightarrow \{(u,v) \colon u, v \in
V\}$ es la funci\'on de incidencia de $G$, que asocia cada elemento de $E(G)$
una pareja no ordenada de $V(G)$. Para un $e \in E(G)$ y $u,v \in V(G)$, tales
que $\psi_G(e)= \{u, v\}$, decimos que $e$ es incidente en $u$ y en $v$. A su
vez, los v\'ertices $u$ y $v$ son extremos de la arista $e$. De igual manera
podemos decir que $u$ y $v$ son v\'ertices adyacentes o vecinos. Al conjunto de
vecinos de un v\'ertice $v$ se le llama vecindad y se denota $N_G(v)$. y al
n\'umero de aristas incidentes en $v$ se le llama grado de $v$. Un v\'ertice
aisaldo, es decir, un v\'ertice que no tiene vecinos, tiene grado $0$.

Cuando una arista incide en un solo v\'ertice, es decir, ambos extremos son el
mismo v\'ertice, se le llama un lazo. Por otro lado, podemos tener varias
aristas con los mismos extremos, en este caso decimos que los v\'ertices tienen
aristas multiples. Una gr\'afica simple es una gr\'afica $G$ que no tiene lazos
ni aristas m\'ultiples, en otras palabras, entre dos v\'ertices incide a lo
m\'as una arista. .... nos enfocaremos en gr\'aficas simples, por lo que seran
referidas simplemente como gr\'aficas.

Las gr\'aficas pueden ser representadas por diagramas en los que cada v\'ertice
es representado como un c\'irculo y cada arista es representada como una l\'inea
con extremos en sus v\'ertices incidentes. Cabe recalcar que una gr\'afica $G$
puede tener  m\'ultiples diagramas (EJEMPLO).
...
\section{Algunas propiedades de gr\'aficas}
\label{sec:propGrapf}
...
\section{Conptos de coloraci\'on}
