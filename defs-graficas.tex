...
%comunmente
    ...
    Al poderle asignar una longitud a un camino, ser\'ia natural utilizarla para
   ...
   los mismos v\'ertices y aristas que $X$.
    ...
    Al igual que en el caso de las trayectorias, vale la pena resaltar el caso
    en el que un camino cerrado no repite v\'ertices. Un ciclo es un camino
    cerrado de longitud al menos $3$ que, adem\'as, no repite v\'ertices, salvo
    los extremos. 
