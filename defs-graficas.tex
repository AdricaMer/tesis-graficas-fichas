...
por v\'ertices} si $|S|=k$. Cabe notar que no todas las gr\'aficas tienen
...
la conexidad de una gr\'afica. El \indice{n\'umero de conexidad} de una
...
\indiceSub{gr\'afica}{$t$-conexa} para toda $t \in \mathbb{N}$ tal que
