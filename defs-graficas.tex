...
gr\'aficas son copias de la gr\'afica $K_2$ (mencionada en la
...
esta secci\'on nos enfocamos en las familias  y propiedades de \'estas que son
...
\begin{proof}
    En el caso en el que el que $G$ es una gr\'afica conexa, tenemos que s\'olo tiene una
