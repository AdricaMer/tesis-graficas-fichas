...
importante se\~{n}alar que una \indiceSub{v\'ertices}{partici\'on}\index{partici\'on}
de $V(G)$ en $V_1, V_2, \dots, V_k$ partes debe satisfacer $V_1 \cap V_2 \cap
\cdots \cap V_k = \varnothing$ y $V_1 \cup V_2 \cup \cdots \cup V_k = V(G)$. Con
\'esto pasamos a definir la familia de gr\'aficas. Una gr\'afica es
