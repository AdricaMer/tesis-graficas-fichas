...
intersecci\'on, por lo que el 
\linebreak
$XY$-corte por v\'ertices $S$ deja a $X\setminus
...
\begin{proof}
    Sea $G$ una gr\'afica y sean $X,Y \subseteq V(G)$. Primero, consideramos
    el caso en el que un conjunto de v\'ertices est\'a contenido en el otro, sin
