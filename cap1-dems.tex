...
En este capitulo nos enfocaremos en la conexidad de las gr\'aficas de fichas.
...
basandonos en las caractere\'isticas y par\'ametros de las gr\'aficas de cuales
provienen.
...
%Note that both bounds in Theorem 1 are achievable. If P δ+1 is the path on δ +
%1 vertices and k ≤ δ + 1, then P δ+1 has diameter δ and F k (P δ+1 ) has
%diameter k(δ− k + 1).


El teorema que a continuaci\'on se muestra que algunas subgr\'aficas inducidas
de las gr\'aficas de fichas son productos cartecianos.
