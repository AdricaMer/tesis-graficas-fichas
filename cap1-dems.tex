...
toda $k$ obtenemos una gr\'afica de $k$-fichas de di\'ametro $k(d-k+1)$. La
Figura \ref{fig:ex-diamP} muestra la trayectoria $P_6$ con todas sus posibles
gr\'aficas de fichas, con $k<6$. Recordamos que $F_2(P_6) \cong F_4(P_6)$ y
$F_1(P_6) \cong F_5(P_6)$. %Falta P_6 en la figura, donde se pone?
...
de trayectorias internamente ajenas. Para llegar a estos resultados, primero se
necesitan demostrar dos lemas que nos ser\'an de utilidad.
