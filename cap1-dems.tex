...
Consideramos $A= \{1,2,3\}$ y $B=\{2,3,5\}$ los v\'ertices en $F_3(G)$ sobre los
que veremos los distintos tipos de trayectorias internamente en $F_3(G)$ que
encontramos en \cref{lem:TrayIntAj}. Tenemos que ${\color{gris}A\triangle
...
a ambos como v\'ertices internos. Tomamos ${\color{lila}}P_1=(1,4,5)$ y
${\color{amarilloOscuro}Q_1(1,2,3,5)}$. Ahora tomamos ${\color{amarilloOscuro}2} \in C$ y su vecino
...
\centering
   \begin{tikzpicture}
    ...
    \begin{scope}[xshift=-8.5cm]
        ...
        \foreach \i in {0,4}
            \draw ({(360/6)*\i}:2) node(\i)[wvertex,fill=gris]{};
        \foreach \i in {1,2}
            \draw ({(360/6)*\i}:2) node(\i)[wvertex,fill=amarilloOscuro]{};
        \draw ({(360/6)*3}:2) node(3)[wvertex,fill=lila]{};
        \draw ({(360/6)*5}:2) node(5)[wvertex,fill=blue]{}; 
        \foreach \i in {0,...,5}
        ...
        \foreach \i/\j in {0/1,1/2,2/4}
            \draw [edge,amarilloOscuro] (\i) to (\j);
        \foreach \i/\j in {0/3,3/4}
            \draw [edge,lila] (\i) to (\j);
    ...
    \begin{scope}[xshift=0cm,yshift=0cm,scale=1]
        ...
        \foreach \i in {6,11} 
            \draw ({(360/16)*\i}:4) node(\i)[wvertex,fill=amarilloOscuro]{}; 
        \foreach \i in {0,2,15} 
            \draw ({(360/16)*\i}:4) node(\i)[wvertex,fill=verdeAzulado]{}; 
        
        \draw ({(360/16)*5}:4) node(5)[wvertex,fill=gris]{};
        \draw ({(360/16)*8}:4) node(8)[wvertex,fill=lila]{};     
        ...
        \draw (0.3,1.4) node (20) [vertex,fill=gris ,label=88:{\tiny $235$}] {};
        ...
        \foreach\i/\j in{5/6,6/11,11/20} 
           \draw [wedge,amarilloOscuro] (\i) to (\j);
        \foreach\i/\j in{5/8,8/20} 
           \draw [wedge,lila] (\i) to (\j);
...
\end{tikzpicture}
\caption{Ejemplo de una gr\'afica $G$ y su $3$-gr\'afica de fichas}
