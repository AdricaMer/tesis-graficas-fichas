...
%TODO checar que no falten aristas en la grafica de fichas 
\begin{figure}[ht!]
\centering
   \begin{tikzpicture}
    ...
    \begin{scope}[xshift=-8.5cm]
        \foreach \i in {0,...,5}
            \draw ({(360/6)*\i}:2) node(\i)[wvertex]{\pgfmathparse{int(\i+1)}
            \pgfmathresult};
   ...
   \end{scope}
        ...
        \foreach \i/\j in{1/8,3/13,3/14,5/11,7/14,9/0,9/18,17/3,17/4,17/5,17/6,17/8,
