...
\begin{proof}
    ...
    Las \'ultimas trayectorias a considerar son las trayectorias de tipo $R$,
    que construimos a continuaci\'on utilizando los vecinos de los v\'ertices en
    $A \cap B$. Empezamos considerando $v \in C$, as\'i $v \in Q_i$ para un $i
...
=\{a_1, \dots, a_r\}$ y
\linebreak
 $B \setminus A =\{b_1, \dots, b_r\}$. Tambi\'en
definimos $A_{i,x} = (A\setminus \{a_i\}) \cup \{x\}$ y 
\linebreak
$B_{j,x} = (B\setminus
...
\{a_i, b_j\}$. Por lo que 
\linebreak
$|A_{i,x} \triangle B_{j,x}| = 2(r-1)$. As\'i, tenemos
...
\begin{teorema}%
    ...
    \begin{proof}
        ...
        \linebreak
        $|\mathcal{C}| \ge r(n-k-r)+2r^2$. Dado que $r \ge 2$ y $n \ge
        \frac{1}{2}kt$, entonces tenemos que 
        \[
