...
\cong K_1$. \Cref{fig:ex-diamP} muestra las gr\'aficas de $2$ y
...
\textbf{X}},{\color{baige} \textbf Y})$. Sea ${\color{azulMetal}\bf M}$ el conjunto
de aristas azules mencionado en \cref{lem:rb-bipGraph}, resaltadas en figura.
Entonces tenemos que ${\color{azulMetal} \bf M=\{v_1v_8, v_2v_9,v_3v_7,v_4v_{10}\}}$.
Notemos que todo v\'ertice en ${\color{baige} \bf Y}$ tiene exactamente una arista en
${\color{azulMetal}\bf M}$. Adem\'as, la uni\'on de las aristas de
