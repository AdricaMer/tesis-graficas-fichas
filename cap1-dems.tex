...
\begin{proof}
    ...
    internamente ajenas en $G$. Por lo tanto, por el \Cref{lem:primero}, existen
   ...
   \begin{tikzpicture}
    ...
    \begin{scope}[xshift=0cm,yshift=0cm,scale=1]
       \foreach \i in {0,...,15} \draw ({(360/16)*\i}:4)
        ...
        \draw ({(360/16)*2}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*3}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*4}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*5}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*6}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*7}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*8}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*9}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*10}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*11}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*12}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*13}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*14}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*15}:4.5) node (e1) {{\footnotesize $2$}};
        \draw ({(360/16)*16}:4.5) node (e1) {{\footnotesize $2$}};
        ...
        \draw (-1,1) node (17) [vertex, label=90:{\tiny $17$}] {};
        \draw (-1,-1) node (18) [vertex, label=180:$a$] {};
        \draw (1,-1) node (19) [vertex, label=270:$a$] {};
        \draw (1,1) node (20) [vertex, label=0:$a$] {};
