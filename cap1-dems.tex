...
\begin{figure}[ht!]
    ...
    inducidas, ${\color{baige}\bf H_1}$ y ${\color{azulMetal}\bf H_2}$. $F_3(G)$
    (derecha), resaltando su subgr\'afica inducida ${\color{fushia}\bf F_1(H_1)
    \square F_2(H_2)}$.}
    \label{fig:ex-cart}
    \end{figure}
...
\caption{Una bigr\'afica completa, resaltando la uni\'on de aristas
