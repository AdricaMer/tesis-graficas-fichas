...
\begin{proposicion}
\label{prop:iso-SFan}
    Sean $k$ un entero positivo, y  $V_i=\{ Y \in V(F_k(\mathcal{F}_n)) \colon\
    v_i \in Y \}$ un subconjunto de v\'ertices de $F_k(\mathcal{F}_n)$, con $1
    \leq i \leq n-k$. Si $S_i$ es la subgr\'afica de $F_k(\mathcal{F}_n)$
    inducida por $V_i$, entonces $S_i$ es isomorfa a
    $F_{k-1}(\mathcal{F}_{n-i})$.
\end{proposicion}
    
\begin{proof}
    Siguiendo la convenci\'on del $(n-i)$-\'esimo abanico, sea
    $V(\mathcal{F}_{n-i}) = \{v_{i+1}, v_{i+2}, \dots, v_n\}$, con $V(P_{n-i-1})
    = \{v_{i+1}, v_{i+2}, \dots, v_{n-1}\}$ y $V(K_1)= \{v_n\}$, por
    definici\'on. Basta demostrar que existe un isomorfismo entre las gr\'aficas
    $S_i$ y $F_{k-1}(\mathcal{F}_{n-1})$. Proponemos a la funci\'on $A
    \xrightarrow[]{} A \setminus \{v_i\}$ como dicho isomorfismo. Nos fijamos
...
\begin{proof}
    Usando doble inducci\'on sobre $k$ y $n$, demostraremos que la gr\'afica
...
\begin{figure}[ht!]
    ...
    \begin{scope}[scale=0.85]
        ...
        \begin{scope}[xshift=-5.5cm,yshift=0cm,scale=0.8]
            ...
            \draw (-0.6,0) node (v2) [vertex,label=270:{\small $v_2$}] {};
            \draw (0.6,0) node (v3) [vertex,label=270:{\small $v_3$}] {}; 
            ...
            \draw (2,2.3) node (w4) [vertex,label=90:{\small $w_4$}] {};
            \draw (-2,-2.3) node (w5) [vertex,label=270:{\small $w_5$}] {}; 
            \draw (-0.75,-2.3) node (w6) [bvertex,fill=coral,label=270:{\small $w_6$}] {};
            \draw (0.75,-2.3) node (w7) [vertex,label=270:{\small $w_7$}] {};
            \draw (2,-2.3) node (w8) [vertex,label=270 :{\small $ w_8$}] {};
        ...
        \begin{scope}[xshift=0cm,yshift=0cm,scale=0.8]
            ...
            \draw (0.75,2.3) node (w3) [vertex, label=90:{\small $w_3$}] {};
            \draw (2,2.3) node (w4) [vertex,label=90:{\small $w_4$}] {};
            \draw (-2,-2.3) node (w5) [bvertex,fill=lila ,label=270:{\small $w_5$}] {}; 
            \draw (-0.75,-2.3) node (w6) [bvertex,fill=coral,label=270:{\small $w_6$}] {};
            \draw (0.75,-2.3) node (w7) [vertex,label=270:{\small $w_7$}] {};
            \draw (2,-2.3) node (w8) [vertex,label=270 :{\small $ w_8$}] {};
        ...
        \begin{scope}[xshift=5cm,yshift=0cm,scale=0.8]
            \draw (-1.8,0) node (v1) [vertex,label=240:{\small $v_1$}] {};
            \draw (-0.6,0) node (v2) [vertex,label=270:{\small $v_2$}] {};
            \draw (0.6,0) node (v3) [bvertex,fill=lila ,label=270:{\small $v_3$}] {}; 
            \draw (1.8,0) node (v4) [vertex,label=300:{\small $v_4$}] {}; 
            \draw (-2,2.3) node (w1) [vertex,label=90:{\small $w_1$}] {}; 
            \draw (-0.75,2.3) node (w2) [vertex,label=90:{\small $w_2$}] {};
            \draw (0.75,2.3) node (w3) [vertex, label=90:{\small $w_3$}] {};
        ...
        \begin{scope}[xshift=0cm,yshift=-5.5cm,scale=0.8]
            \draw (-1.8,0) node (v1) [vertex,label=240:{\small $v_1$}] {};
            \draw (-0.6,0) node (v2) [bvertex,fill=lila ,label=270:{\small $v_2$}] {};
            \draw (0.6,0) node (v3) [vertex,label=270:{\small $v_3$}] {}; 
            \draw (1.8,0) node (v4) [vertex,label=300:{\small $v_4$}] {}; 
            \draw (-2,2.3) node (w1) [vertex,label=90:{\small $w_1$}] {}; 
            \draw (-0.75,2.3) node (w2) [vertex,label=90:{\small $w_2$}] {};
        ...
        \begin{scope}[xshift=5cm,yshift=-5.5cm,scale=0.8]
            ...
            \draw (-0.75,-2.3) node (w6) [bvertex,fill=coral,label=270:{\small $w_6$}] {};
            \draw (0.75,-2.3) node (w7) [vertex,label=270:{\small $w_7$}] {};
            \draw (2,-2.3) node (w8) [bvertex,fill=lila,label=270 :{\small $ w_8$}] {};
        ...
        \begin{scope}[xshift=2.5cm,yshift=-11cm,scale=0.8]
            ...
            \draw (-2,-2.3) node (w5) [vertex,label=270:{\small $w_5$}] {}; 
            \draw (-0.75,-2.3) node (w6) [bvertex,fill=coral,label=270:{\small $w_6$}] {};
            \draw (0.75,-2.3) node (w7) [bvertex,fill=lila,label=270:{\small $w_7$}] {};
            \draw (2,-2.3) node (w8) [vertex,label=270 :{\small $ w_8$}] {};
...
\Cref{fig:exe-tray-n-m} muestra la configuraci\'on de las fichas en la gr\'afica
