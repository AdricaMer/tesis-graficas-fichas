...
\begin{proof}
    ...
    \xrightarrow[T_2]{}\{v_2,v_n\},\{v_3,v_n\} \xrightarrow[{T_3}^{-1}]{}\{v_3,w_1\},
    \dots, \{v_{n-1},v_n\}
    \xrightarrow[{T_{n-1}}^{-1}]{}\{v_{n-1},w_1\},\{v_n,w_1\},\{v_1,v_n\})$.
    ...
    fichas en $\mathcal{F}_{8,4}$. Cada copia representa un v\'ertice de la
    trayectoria $P_6
    =(\{v_4,w_6\},\{w_5,w_6\},\{v_3,w_6\},\{w_1,w_6\},\{v_2,w_6\},\{w_8,w_6\},\{v_1,w_6\},\{w_7,w_6\})$
    en $F_2(\mathcal{F}_{8,4})$, empezando por la gr\'afica de la esquina
    superior izquierda. Observamos que la ficha en ${\color{coral}\boldsymbol
...
es el ciclo hamiltoniano buscado. \Cref{fig:exe-tray-n-m} muestra la
configuraci\'on de las fichas en la gr\'afica $\mathcal{F}_{3,4}$ para generar
la trayectoria $P_2$ en la gr\'afica de $2$-fichas. Donde
