...
\begin{proposicion}
        ...
        \begin{proof}
            ...
            entre gr\'aficas entre $S_i$ y $F_{k-1}(\mathcal{F}_{n-1})$.
            Proponemos a la funci\'on $A \xrightarrow[]{} A \setminus \{v_i\}$
            como el isomorfismo que buscamos. Nos fijamos que para $A \in
        ...
        \begin{proof}
            ...
            Ahora veamos el caso de la gr\'afica de $2$-fichas de $\mathcal{F}_n$, con $n
