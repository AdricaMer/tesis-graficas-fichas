...
porvienen de $P_n$ y los que vienen de $\overline{K_m}$,denotamos $v_i$ y $w_j$
...
\begin{proof}
    ...
    elemento es $\{w_i, w_{i+1}\}$, que son adyacentes por el agumento
    ...
    fij\'emosnos que los v\'ertices $\{w_i,v_j\}$ est\'an en $P_i$, para $i\in
...
\begin{proof}
    ...
    \dots, v_{n-2}, v_{n-1}\}$ son adyacentes. Notamos que, cuando $m
    =1$, haciedo un cambio de
    notaci\'on de $w_1$ a $v_n$ tenemos un abanico como el
...
%G con $n+1 < m \leq 2n$ tampoco es hamiltoniana??