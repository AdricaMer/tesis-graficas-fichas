...
\begin{proof}
    ...
    s_m\in \mathbb{Z^{+}}$ enteros positivos como en el enunciado. Llamamos $L$
    al conjunto de los $k$-subconjuntos de $G$ que cumplen tener exactamente
    $s_i$ elementos de $H_i$, para toda $i \in \{1, \dots, m\}$, es decir, $L = \{A
    ...
    subgr\'afica inducida de $F_k(G)$ por $L$, i.~e., $F_k(G,L)$, es isomorfa
    a $F_{s_1}(H_1) \square \cdots \square F_{s_m}(H_m)$. Primero, analizamos el
    conjunto de v\'ertices de ambas gr\'aficas. Sea $A \in
    V(F_k(G,L))$, tal que $A=\{a_1, \dots, a_{s_1}, b_1,\dots,
