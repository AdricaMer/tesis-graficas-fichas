    ...
    \centering
       \begin{tikzpicture}
        ...
        \begin{scope}[xshift=-5.5cm]
            \draw (0,1.5) node (1) [vertex,fill=verde ,label=90:{\scriptsize $1$}] {};
            \draw (-1,0) node (2) [vertex,fill=salmon ,label=115:{\scriptsize $2$}] {};
            \draw (1,0) node (3) [vertex,fill=salmon ,label=80:{\scriptsize $3$}] {};
            \draw (-1,-1.5) node (4) [vertex,fill=verde ,label=240:{\scriptsize $4$}] {};
            \draw (1,-1.5) node (5) [vertex,fill=verde ,label=330:{\scriptsize $5$}] {};
