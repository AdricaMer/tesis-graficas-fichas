...
Utilizando las gr\'aficas en \cref{fig:ex-tok-path}, daremos un ejemplo de los
...
$G$ estan representados en ${\bf negritas}$ en $F_3(G)$.
...
A partir del Teorema\ref{teo:numCrom-k} podemos encontrar una cota inferiror
