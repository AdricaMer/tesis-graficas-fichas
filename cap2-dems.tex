...
Por la caracterizaci\'on obtenida en \cref{teo:clanG-clanFG},
sabemos que un clan $X$ en $F_k(G)$ tiene la misma cardinalidad que $K$, clan en
$G$ como en el teorema. Por ello, podr\'ia parecer que $G$ y $F_k(G)$ tienen el
mismo n\'umero de clan. Sin embargo,\cref{fig:ex-wG} nos muestra un ejemplo en
el que el n\'umero de clan de $G$ es mayor al de $F_k(G)$.
...
un ${\color{azulOscuro}\bf {clan}}$ de cardinalidad $\omega(F_3(K_4))$ (derecha).}
\label{fig:ex-wG}
\end{figure}
...
\Cref{prop:biparticion F(G)} y \cref{teo:numCrom-k}, a continuaci\'on exhibidos,
