           ...
           \begin{tikzpicture}
            ...
            \begin{scope}[xshift=0cm,yshift=0cm,scale=1]
               ...
               \foreach \i in {2,3,5,6,7,8,11,12,13,14,15} \draw ({(360/16)*\i}:4)
                ...
                \draw ({(360/16)*4}:4.5) node (e1) {{\footnotesize $12{\color{amarilloOscuro} 6}$}};
                ...
                \draw (-1.1,0.2) node (17) [vertex, fill=rosa, label=10:{\tiny $124$}] {};
                \draw (0.1,-0.3) node (18) [vertex, fill=rosa, label=70:{\tiny $146$}] {};
