...
esepci\'on del \cref{coro:numClan}.
...
Sin embargo, para este trabajo se considera pertinente poner la demostraci\'on,
por lo que a continuaci\'on pasamos a demostrar el corolario.
...
\begin{proof}
    ...
    entonces $A \triangle B = \{a,b\}$, para algunos v\'ertices $a$ y $b$ de
    $G$, tales que $ab \in E(G)$. Al ser $c'(A) = c'(B)$, tenemos que $\Sigma_{x
